...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"project_name","description":"DESCRIPTION"}'
	test -f README.rst || echo "PROJECT_NAME" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/marskar/project_name.git
