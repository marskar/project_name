...
module_dir = os.path.join(__location__, "../src/project_name")
...
try:
    from project_name import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'user_guide.tex', u'PROJECT_NAME Documentation',
